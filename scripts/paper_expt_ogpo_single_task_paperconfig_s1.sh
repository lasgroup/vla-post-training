...
#SBATCH --job-name=paper_ogpo_pc_s1
#SBATCH --gres=gpu:1
...
# Seed 1 of 3 (paper_expt_ogpo_single_task_paperconfig_s{0,1,2}.sh).
#
...
# and why).
#
# Submit:  sbatch scripts/paper_expt_ogpo_single_task_paperconfig_s1.sh
# ---------------------------------------------------------------------------
set -euo pipefail
...
export ARM="paper_expt_ogpo_single_task_paperconfig_s1"
