...
Usage:
    ./scripts/grouped_mpo_agent/launcher_noTD.py --project_name vla_debug_march26_noTD
    ./scripts/grouped_mpo_agent/launcher_noTD.py --project_name my_project --dry
    ./scripts/grouped_mpo_agent/launcher_noTD.py --project_name my_project --mode local
"""
...
applicable_configs: Dict[str, List[Any]] = {
    ...
    "batch_size": [128],
    "rl.td_weight_schedule.switch_step": [5000],
