...
#SBATCH --job-name=paper_ogpo_fast_s2
...
# derived from the 2026-09-20 probe series. Seed 2 of 3
...
echo "[paper-fast-s2] node=$(hostname) job=${SLURM_JOB_ID:-?} cuda=$CUDA_VISIBLE_DEVICES mujoco_egl=$MUJOCO_EGL_DEVICE_ID"
...
uv run scripts/exp.py pi05_libero_online_ogpo_ref \
  ...
  --exp_name stab_paper_expt_ogpo_single_task_fast_s2 \
