...
#SBATCH --job-name=paper_ogpo_mt4_s1
#SBATCH --gres=gpu:1
...
# tasks only). Seed 1 of 3 (paper_expt_ogpo_multitask_s{0,1,2}.sh). Multitask
...
#
# Submit:  sbatch scripts/paper_expt_ogpo_multitask_s1.sh
# ---------------------------------------------------------------------------
set -euo pipefail
