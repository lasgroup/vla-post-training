...
EXP_NAME=pi05_libero_online_best_of_n_multitask4_seed0
CKPT_BASE_DIR=$STORE_ROOT/checkpoints/bon_multitask
...
# not FSFT's 5k/500. Task set is AWR's / FSFT's 4-task sweep entry.
#
