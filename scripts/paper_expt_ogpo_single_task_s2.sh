...
#SBATCH --job-name=paper_ogpo_st_s2
#SBATCH --gres=gpu:1
...
# only). Seed 2 of 3 (paper_expt_ogpo_single_task_s{0,1,2}.sh).
#
...
#
# Submit:  sbatch scripts/paper_expt_ogpo_single_task_s2.sh
...
export ARM="paper_expt_ogpo_single_task_s2"
