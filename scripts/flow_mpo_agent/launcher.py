...
Holds AWR's tuned defaults constant (beta=0.2, normalizer EMA=0.99,
use_mc_returns=False) and sweeps Flow-MPO's distinctive knobs:
clip_epsilon, use_adaptive_advantage_scale, num_steps, noise_level.

Usage:
    ./scripts/flow_mpo_agent/launcher.py --project_name flow_mpo_sweep
...
applicable_configs: Dict[Union[str, tuple], List[Any]] = {
    ...
    # AWR defaults — kept frozen so flow_mpo stays comparable to AWR.
    "rl.beta": [0.2],
    ...
    # The whole point of flow_mpo's adaptive scale path; ablate against fixed
    # advantage_scale (the legacy path).
    "rl.use_adaptive_advantage_scale": [True, False],
    "rl.num_steps": [10],
    "rl.noise_level": [0.3],
