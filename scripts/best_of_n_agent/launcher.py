...
DEFAULT_CRITIC_INFERENCE_START_STEP = 500
DEFAULT_NUM_CPUS = 16
...
def main() -> None:
    ...
    parser.add_argument("--env_num", type=int, default=DEFAULT_ENV_NUM)
    parser.add_argument("--num_train_steps", type=int, default=DEFAULT_NUM_TRAIN_STEPS)
