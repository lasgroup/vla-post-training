...
Usage:
    ./scripts/residual_rl_agent/launcher.py --project_name my_project
    ./scripts/residual_rl_agent/launcher.py --project_name my_project --dry
    ./scripts/residual_rl_agent/launcher.py --project_name my_project --mode local
"""
...
SCRIPT = "scripts/residual_rl_agent/exp.py"
CONFIG_NAME = "pi05_libero_online_residual_rl"
PROJECT_NAME = "residual_rl_agent_sweep"
