...
class AdvantageWeightedSFTLearner(FilteredSFTLearner):
    ...
    def update(self) -> dict:
        ...
        # mc_returns are available from both online and offline buffers
        if rl_config.use_mc_returns and not use_online and not has_offline:
            update_policy = False
