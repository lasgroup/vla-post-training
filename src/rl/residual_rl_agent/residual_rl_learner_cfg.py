...
class SACModelConfig:
    ...
    def create(self, rng):
        ...
        from src.rl.residual_rl_agent.residual_rl_learner import SACModel
        return SACModel(
            self.obs_dim, 
            self.action_dim, 
            self.hidden_dim, 
...
class ResidualRLTrainConfig:
    ...
    resume: bool = False
    checkpoint_dir: str = "/tmp/residual_rl_checkpoints"
    checkpoint_base_dir: str = "/tmp/residual_rl_checkpoints"
    ...
    exp_name: str = "residual_rl_experiment"
    project_name: str = "residual_rl"
    name: str = "residual_rl_run"
